...
import org.poc.android.drawing.OverlappingCopy;
import org.poc.android.drawing.RectList;
import org.poc.common.ObjectPool;
...
public class LargeBitmapData extends AbstractBitmapData {
	 ...
	 */
	public LargeBitmapData(RfbProto p, VncCanvas c, int displayWidth, int displayHeight, int capacity)
	{
		super(p,c);
